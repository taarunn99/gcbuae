...
// SpecularButton from React Bits (TypeScript + CSS variant), adapted only in
// import style. A WebGL rim of light hugs the button edge and steers toward
// the pointer.
...
const SpecularButton = ({
  ...
  // Mirrored into a ref after every commit so the RAF loop always reads the
  // latest props without re-running the WebGL setup effect.
  useEffect(() => {
    propsRef.current = {
      radius,
      lineColor,
