...
export const content: BlogContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Estimates end where slabs begin. The working process: send the scope, a BOQ, a cutting list, or even room dimensions and the shortlisted shades, through [the contact form](/contact) or WhatsApp, and an AED quotation against live Al Sajaa stock comes back, usually within one working day, itemising slabs, any fixing scope and lead times. No minimum order applies, though the pricing works hardest at project volume: full-slab lots, complete floors, container quantities.\n\nTwo habits make the quote sharper. Name the exact shades from the [catalogue](/kalingastone), since series moves the band more than anything else; and state whether you want supply-only or supply-and-fix, because comparing across those bases is where stone budgets go wrong. Trade buyers are welcome to view and tag their exact slabs before committing, which is the difference between buying from a stockist and gambling with a trader, as the [supplier-vetting guide](/blog/marble-slab-supplier-uae-how-to-choose) puts it.",
    },
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: "Generally yes on like-for-like looks: KalingaStone's value engineering undercuts premium imported quartz brands while matching daily performance. The full comparison covers where each wins.",
    },
    {
    ...
    },
    {
      ...
      a: "Global Classic Building Materials is an authorized KalingaStone reseller for the Northern Emirates, in writing, holding all three materials as full slabs at Al Sajaa, Sharjah with UAE-wide delivery.",
    },
  ],
};
